...
class TestFactorDefs:
    ...
    def test_import_from_quant_engine(self):
        from engine.quant.predictor import FACTOR_DEFS, FactorDef
...
class TestStockPredictorV2:
    ...
    def test_predict_basic(self):
        from engine.quant.predictor import StockPredictorV2, PredictionResult
    ...
    def test_predict_too_few_stocks(self):
        from engine.quant.predictor import StockPredictorV2
        pred = StockPredictorV2()
